...
\subsection{Implementation du Contrôleur SRAM}
...
Ces signaux seront mis à 0 dans un état précédent l'état \verb|IDLE| qui est l'état \verb|INIT|.\\
...
La configuration de la simulation est disponible dans le répertoire GitHub sur le nom de \verb|tb_sram_controller_behav.wcfg|.\\
% - Image - %
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Image/tb_SRAM_simulation.png}
\caption{Simulation Test Bench Contrôleur SRAM}
\end{figure}

Des marqueurs ont été placés pour indiquer les lectures aux différentes adresses.\\
