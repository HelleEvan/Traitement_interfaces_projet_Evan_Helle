...
confusion avec le signal Ld\_n
j'ai forcé l'incrementation de l'adresse par le controlleur
si on veut faire propre, on reprend le code et on change le'incrementation forcée par celle de la sram 
pour l'instant on garde comme ça pour valider le mode burst