...
Nous avons forcé l'incrementation de l'adresse par le Contrôleur durant le mode burst.\\
...
Le fait qu'on ait utilisé un compteur forcé au lieu du Ld\_n permet de ecrire/lire plus de 4 données à la suite car on est limité avec le compteur de la sram.\\
